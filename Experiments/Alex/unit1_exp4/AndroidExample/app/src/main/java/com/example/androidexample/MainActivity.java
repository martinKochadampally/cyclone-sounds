        ...
        changePasswordButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (extras.getString("PASSWORD") == null) {
                    Toast.makeText(getApplicationContext(), "Password not set", Toast.LENGTH_LONG).show();
                }
                /* when Change Password button is pressed, use intent to switch to ChangePassword Activity */
                else {
